...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    meta: {
<<<<<<< Updated upstream
      modelProps: 'user' | 'organization' | 'document' | 'dropPoint' | 'manager' | 'donation' | 'feedback' | 'peripheral' | 'city' | 'advertisement' | 'adInteraction'
=======
      modelProps: 'user' | 'organization' | 'document' | 'dropPoint' | 'admin' | 'manager' | 'donation' | 'feedback' | 'peripheral' | 'city' | 'advertisement' | 'adInteraction' | 'listing' | 'photo' | 'category' | 'condition'
>>>>>>> Stashed changes
