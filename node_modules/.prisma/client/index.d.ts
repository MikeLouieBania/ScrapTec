...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'organization' | 'document' | 'dropPoint' | 'manager' | 'donation' | 'feedback' | 'peripheral' | 'city' | 'advertisement' | 'adInteraction' | 'listing' | 'photo' | 'category' | 'condition'
